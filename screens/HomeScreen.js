        ...
        <View style={styles.newsTitleContainer}>
          <Text style={styles.titleText}>Recent News</Text>
            <View style={styles.newsButtonContainer}>
                ...
                <Icon style={styles.icon} name="keyboard-arrow-right" size={20} color="black" />
                </TouchableOpacity>
            </View>
      ...
      <View style={styles.petContainer}>
        ...
        <View style={styles.petProfileContainer}>
          <View style={styles.petImageContainer}>
                    <Image source={require('../assets/pauline.jpg')} style={styles.imageContainer} />
                </View>
        ...
        <View style={styles.petProfileContainer}>
          <View style={styles.petImageContainer}>
                    <Image source={require('../assets/jeanie.jpg')} style={styles.imageContainer} />
                </View>
            <View style={styles.petTextContainer}>
